...
class EnvGenTestSuite(unittest.TestCase):
    def test_create_envs(self):
        ...
        self.assertEqual(True, os.path.exists(os.path.dirname(DEFAULT_PATH + "/dev.env")))
        self.assertEqual(True, os.path.exists(os.path.dirname(DEFAULT_PATH + "/staging.env")))
        self.assertEqual(True, os.path.exists(os.path.dirname(DEFAULT_PATH + "/prod.env")))
