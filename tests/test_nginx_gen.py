...
class NginxGenTestSuite(unittest.TestCase):
    def test_create_nginx(self):
        ...
        self.assertEqual(True, os.path.exists(os.path.dirname(DEFAULT_PATH + "/nginx/Dockerfile")))
        self.assertEqual(True, os.path.exists(os.path.dirname(DEFAULT_PATH + "/nginx/nginx.conf")))
